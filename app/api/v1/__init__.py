...
api.add_resource(IncidentEndpoint, '/incident/<int:incident_id>')
api.add_resource(IncidentEditCommentEndpoint, '/incident/<int:incident_id>/comment')
api.add_resource(IncidentEditLocationEndpoint, '/incident/<int:incident_id>/location')
